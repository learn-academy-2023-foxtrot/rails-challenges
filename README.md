...
This repository holds the Ruby on Rails pair programming challenges for Unit 6 at LEARN Academy.
...
- $ `git checkout -b <topic-initials1-initials2>` (ex. validations-aw-sp)
